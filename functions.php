...
add_action( 'wp_enqueue_scripts', function() {
    ...
    //wp_enqueue_script( 'kute', '/js/kute.min.js', array(), null, array('strategy' => 'defer', 'in_footer' => true)  );
...
add_action( 'wp_enqueue_scripts', function() {	   
    ...
    wp_enqueue_script('kute', get_stylesheet_directory_uri() . '/js/kute.min.js', array(/* 'jquery' */), null, array('strategy' => 'defer', 'in_footer' => true) );
